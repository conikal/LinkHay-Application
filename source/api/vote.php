...
$subject = $cc->post($linkhay . '/link/item/vote', http_build_query($data_vote));
echo $subject;
preg_match('/{(.*?)}/', $subject, $vote_result);
$result = json_decode($vote_result[0]);
print_r($result);
